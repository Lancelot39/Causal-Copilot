...
class Provenance:
    ...
    planner_model: str | None = None  # e.g. "gpt-4o-2024-05-13"
    prompt_version: str | None = None  # hash of prompt template
...
class TreatmentEffect:
    ...
    ate: float | None = None
    ate_ci: tuple | None = None  # (lower, upper)
    att: float | None = None
    att_ci: tuple | None = None
...
class CausalResult:
    ...
    node_names: list[str] | None = None  # column/variable names matching matrix indices
    graph: Any | None = None  # nx.DiGraph when available
